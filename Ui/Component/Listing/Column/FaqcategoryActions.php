...
class FaqcategoryActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * Url path  to edit
     *
     * @var string
     */
    const FAQ_CATEGORY_URL_PATH_EDIT = 'alsurmedia/faqcategory/edit';
     ...
     * @var string
     */
    const FAQ_CATEGORY_URL_PATH_DELETE = 'alsurmedia/faqcategory/delete';
