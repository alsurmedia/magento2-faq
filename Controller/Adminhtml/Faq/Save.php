...
namespace Alsurmedia\Faq\Controller\Adminhtml\Faq;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Alsurmedia\Faq\Model\Faq $model */
            $model = $this->_objectManager->create('Alsurmedia\Faq\Model\Faq')->load($id);
    ...
    {
        if ($this->_authorization->isAllowed('Alsurmedia_Faq::faq_edit') || $this->_authorization->isAllowed('Alsurmedia_Faq::faq_create')) {
            return true;
        }
        return false;
    }
