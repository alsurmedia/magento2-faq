...
namespace Alsurmedia\Faq\Block\Adminhtml\Faq\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * Category
     *
     * @var \Alsurmedia\Faq\Model\Config\Source\Category
     */
    protected $_category;
    ...
    /**
     * @param \Alsurmedia\Faq\Model\Config\Source\Category $category
    ...
    public function __construct(
        \Alsurmedia\Faq\Model\Config\Source\Category $category,
    ...
    protected function _prepareForm()
    {
        ...
        $formData = $this->_coreRegistry->registry('alsurmedia_faq');
        if ($formData) {
